...
export default function AddCoupleModal({ isOpen, onClose, onSuccess }: AddCoupleModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-6 w-full max-w-md max-h-[90vh] overflow-hidden">
        <div className="flex justify-between items-center mb-4 sticky top-0 bg-white z-10 p-2 border-b border-gray-200">
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-4rem)] p-2">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end space-x-3 mt-6 sticky bottom-0 bg-white pt-4 border-t border-gray-200 z-10">
              <button
                type="button"
                onClick={onClose}
